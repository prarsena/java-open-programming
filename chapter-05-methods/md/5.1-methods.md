...
public static void greetUser(String name) {
    ...
    IO.println("Hope you enjoy learning Java.");
...
public class SimpleMethod {
    ...
    void displayHeader() { // Method definition (Header + Body)
        // Method Body
        IO.println("----------------------------------------");
        IO.println("  Method displayHeader() is Executing   ");
        IO.println("----------------------------------------");
    }
}
```
...
public class LayeredCallDemo {
    void main() {
        IO.println("1.  In main: Calling methodA.");
        methodA(); // Program execution pauses here and jumps to methodA
        IO.println("5.  In main: Back from methodA. Program finishing.");
    }

    void methodA() {
        IO.println("  2.  In methodA: Calling methodB.");
        methodB(); // Execution pauses here and jumps to methodB
        IO.println("  4.  In methodA: Back from methodB. Finishing methodA.");
    }

    void methodB() {
        IO.println("      3.  In methodB: Deepest point.");
