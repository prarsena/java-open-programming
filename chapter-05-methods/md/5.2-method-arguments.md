...
public class PassArg {
    void welcomeUser(String name) { // 'name' is the parameter
...
public class PassByValueDemo {
    void changeValue(int num) {
      ...
      IO.println("Inside method: num = " + num);
   }

   void main() {
      int x = 10;
      IO.println("Before call: x = " + x); // x is 10
      changeValue(x); // A copy of 10 is passed
      IO.println("After call: x = " + x);  // x is still 10
   }
}
