...
public class StarMap {
    void main() {
        ...
        for (int row = 0; row < coordinates.length; row++) {
            IO.print("Cluster " + row + " coordinates: ");
            ...
            for (int col = 0; col < coordinates[row].length; col++) {
                IO.print(String.format("[%.1f] ", coordinates[row][col])); // Use String.format for clean output
            }
            IO.println(""); // Move to the next line after finishing a row
        }
    }
}
```
