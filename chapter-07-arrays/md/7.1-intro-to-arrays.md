...
public class TopArtists {
    void main() {
        ...
        IO.println("Default artist in the first spot (index 0): " + artistNames[0]);
    }
}
```
...
public class PeriodicTable {
    void main() {
        ...
        IO.println("The element at index 0 is: " + elements[0]); // Hydrogen
        IO.println("The element at index 2 is: " + elements[2]); // Lithium

        // Array elements can be treated as any other variable.
        String firstElement = elements[0];
        IO.println("The first element is: " + firstElement);
    }
}
```
