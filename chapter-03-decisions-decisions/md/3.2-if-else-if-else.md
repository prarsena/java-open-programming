...
if (score > 59.9) {
    IO.println("You passed the class.");
} else {
    IO.println("You did not pass the class.");
}
```
...
if (salary >= 40000) {
    if (yearsOnJob >= 2) {
        ...
        IO.println("You must have been on your current job for at least two years.");
    }
} else {
    IO.println("You must earn at least $40,000 per year.");
}
```
...
IO.println("Your grade is " + grade); // Prints: Your grade is C
```
...
if (age >= 16) {
	if (hasLicense) {
		IO.println("You are eligible to drive.");
	}
}
```
